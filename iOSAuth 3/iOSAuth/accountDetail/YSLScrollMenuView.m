...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // default
        _kYSLScrollMenuViewWidth = 80*WIDTH;
        _viewbackgroudColor = [UIColor whiteColor];
        _itemfont = [UIFont systemFontOfSize:13];
        _itemTitleColor = [UIColor colorWithWhite:0.679 alpha:1.000];
...
- (void)setItemTitleArray:(NSArray *)itemTitleArray
{
    if (_itemTitleArray != itemTitleArray) {
        ...
        _indicatorView.frame = CGRectMake(10, _scrollView.frame.size.height - kYSLIndicatorHeight, _kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
